(function() {
  ...
  module.exports = function(process, options) {
    ...
    this.amount = 1;
    this.pourRate = (_ref2 = options.rate) != null ? _ref2 : 1000;
    this.pourFor = (_ref3 = options["for"]) != null ? _ref3 : 0;
    this.pouring = null;
    this.tap = [];
    this.fill = [];
    this.tapOn = true;
    ...
    this.stir = this.start = function() {
      ...
      _this.process.on('SIGKILL', function() {
        if (_this.dropper) return _this.dropper();
      });
        ...
        if ((chunk || data) && _this.fill.length > 0) {
          ...
          for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
            ...
            if (map.data && map.data.length) {
              ...
              _results.push(map.callback.apply(_this, [chunk, data]));
            }
          }
          return _results;
        }
    ...
    this.onDrop = this.onExit = function(callback) {
      return _this.dropper = callback;
    };
